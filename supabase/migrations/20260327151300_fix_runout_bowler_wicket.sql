-- Fix: Run outs should NOT be credited to the bowler's wicket tally.
-- Also ensure "run_out" and "retired_hurt" don't count as bowler wickets.
...
BEGIN
  ...
  -- Run outs, retired hurt, timed out, obstructing the field are NOT bowler wickets
  ...
  IF l_is_wicket THEN
    ...
    -- Only credit bowler for non-run-out wickets
