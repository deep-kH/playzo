-- Fix: Wicket on last ball of over causing incorrect batsman to be removed
-- This reorganizes the strike rotation logic to apply the wicket locally
-- to the variables BEFORE the end-of-over swap logic.
